...
abstract class PayPal {
    ...
    public static function instance($type) {
        if (!isset(PayPal::$instances[$type])) {
            ...
            PayPal::$instances[$type] = new $class($config['username'], $config['password'], $config['signature'], $config['environment'], $config['api_version']);
        }
     ...
     * @return  void
     */
    public function __construct($username, $password, $signature, $environment = 'live', $api_version = '61.0') {
